  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <Plus size={15} />
          {showCreate ? "View Lesson Plans" : "New Lesson Note"}
        </button>
      </div>

      {showCreate ? (
        <form className="bg-white rounded-2xl border border-[#e8e4f3] p-5 shadow-sm space-y-4 max-w-2xl">
          <h3 className="font-extrabold text-slate-900 text-[14px]">Draft Lesson Plan</h3>
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="flex-1 h-11 flex items-center justify-center gap-1.5 rounded-xl border border-slate-200 text-slate-700 font-bold text-[12.5px] hover:bg-slate-50 transition-all"
            >
              Save as Draft
            </button>
            <button
              ...
              className="flex-1 h-11 flex items-center justify-center gap-1.5 rounded-xl text-white font-bold text-[12.5px] transition-all hover:opacity-90"
              style={{ background: "linear-gradient(135deg, #4f46e5, #7c3aed)" }}
            >
