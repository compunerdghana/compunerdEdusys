    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto animate-fade-in">
          <form onSubmit={handleApply} className="bg-white rounded-2xl border border-[#e8e4f3] p-6 shadow-2xl space-y-4 w-full max-w-lg relative animate-scale-up my-8 max-h-[90vh] overflow-y-auto">
            <button
              type="button"
